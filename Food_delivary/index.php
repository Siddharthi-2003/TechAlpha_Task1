...
<body>
  ...
  <!-- <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo">
        <img src="./RES/images/logo.svg" width="148" height="38" alt="Fasteat home">
      </a> -->
      <!--bootstrap -->
...
<!--actual-->
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href="techalphacontact@gmail.com" class="navbar-link" data-nav-link>About Us</a>
          </li>
      ...
      <div class="header-action">
        ...
        <a href="https://www.google.com/search?q=mrityunjoy+restaurant&sca_esv=25bc5e5f5e5d6c4e&sca_upv=1&ei=XeuEZvGXH9CW4-EPstC0oAg&gs_ssp=eJzj4tVP1zc0TKqwyC4ozCozYLRSNagwtkyzsDQ0MTU2MksyNElOszKoMDQwTzQ2NTUxNDK0NLI0NfUSzS3KLKkszcvKr1QoSi0uSSwtSswrAQBJvhc9&oq=mrityunjay+res&gs_lp=-AEBmAIFoAKFE8ICChAuGIAEGLEDGArCAgUQABiABMICChAAGIAEGEMYigXCAgoQLhiABBhDGIoFwgIFEC4YgATCAhkQLhiABBixAxgKGJcFGNwEGN4EGOAE2AEBwgILEAAYgAQYkQIYigXCAgYQABgWGB6YAwC6BgYIARABGBSSBwcyLTQuNy0xoAfMNQ&sclient=gws-wiz-serp" class="btn btn-primary has-after">Order Now</a>
      </div>
  ...
  <main>
    <article>
      ...
      <section class="section hero has-bg-image" aria-label="home"
        style="background-image: url('./RES/images/hero-bg.png')">
        <div class="container">
          ...
          <div class="hero-content" data-reveal="left">
            ...
            <p class="hero-text">
              Get all the cuisine you need for today. <br>
              EAT ->SLEEP ->REPEAT
          ...
          <figure class="hero-banner" data-reveal>
            ...
            <img src="./RES/images/hero-banner.png" width="680" height="720" alt="hero banner" class="w-100">

            <img src="./RES/images/hero-shape-1.svg" width="338" height="138" alt="shape" class="shape shape-1">

            <img src="./RES/images/hero-shape-2.svg" width="237" height="80" alt="shape" class="shape shape-2">
      ...
      <section class="section instruction" aria-labelledby="">
        <div class="container">
          ...
          <p class="section-text" data-reveal>
           Three Simple Steps To Your Dream Food.
          </p>
          ...
          <ul class="grid-list">
            ...
            <li data-reveal="left">
              <div class="instruction-card">
                ...
                <figure class="card-banner">
                  <img src="./RES/images/instructuion-1.png" width="300" height="154" loading="lazy"
                ...
                <div class="card-content">
                  ...
                  <p class="card-text">
                    From the variety of options choose your favorite  restuarant :) 
                  </p>
            ...
            <li data-reveal>
              <div class="instruction-card">
                ...
                <figure class="card-banner">
                  <img src="./RES/images/instructuion-2.png" width="300" height="154" loading="lazy"
                ...
                <div class="card-content">
                  ...
                  <p class="card-text">
                    Select the food you wanna order and place the order
                  </p>
            ...
            <li data-reveal="right">
              <div class="instruction-card">
                ...
                <figure class="card-banner">
                  <img src="./RES/images/instructuion-3.png" width="300" height="154" loading="lazy"
                ...
                <div class="card-content">
                  ...
                  <p class="card-text">
                   here you go , wait maximum 15 minutes to get your order.
                  </p>
          ...
          <ul class="grid-list">
            ...
            <li data-reveal="right">
              <div class="restaurant-card">
                ...
                <div class="card-icon">
                  <img src="./RES/images/rest-1.jpg" width="100" height="100" loading="lazy"
            ...
            <li data-reveal="left">
              <div class="restaurant-card">
                ...
                <div class="card-icon">
                  <img src="./RES/images/rest-2.jpg" width="100" height="100" loading="lazy" alt="The Wilmington"
                    class="w-100">
                </div>
            ...
            <li data-reveal="right">
              <div class="restaurant-card">
                ...
                <div class="card-icon">
                  <img src="./RES/images/rest-3.jpg" width="100" height="100" loading="lazy" alt="Kings Arms"
                    class="w-100">
                </div>
      ...
      <section class="section cta has-bg-image" aria-labelledby="cta-label"
        ...
        <div class="container">
          ...
          <figure class="cta-banner" data-reveal="left">
            <img src="./RES/images/cta-banner.png" width="680" height="704" loading="lazy" alt="cta banner"
              class="w-100">
          </figure>
          ...
          <div class="cta-content" data-reveal="right">
            ...
            <p class="section-text">
             Ordere and get you food in 15 minutes.
            </p>
        ...
        <div class="container">
          ...
          <div class="testi-content" data-reveal="left">
            ...
            <blockquote class="testi-text">
              "The delivery service is prompt and reliable, with my orders consistently arriving on time and in perfect condition. The food is always fresh and delicious, exactly as described. I also appreciate the real-time tracking feature, which keeps me informed about my order status."
            </blockquote>

            <div class="wrapper">
              <img src="./RES/images/testi-avatar.jpg" width="70" height="70" loading="lazy" alt="Thomas Adamson"
                class="author-img">
          ...
          <figure class="testi-banner" data-reveal="right">
            <img src="./RES/images/testimonial-banner.png" width="680" height="588" alt="testimonial banner"
              class="w-100">
          </figure>
          ...
          <ul class="grid-list">
            ...
            <li data-reveal="left">
              <div class="partnership-card">
                ...
                <figure class="card-banner img-holder" style="--width: 640; --height: 402;">
                  <img src="./RES/images/partner-1.jpg" width="640" height="402" loading="lazy" alt="Join Courier"
                    class="img-cover">
                </figure>
            ...
            <li data-reveal="right">
              <div class="partnership-card">
                ...
                <figure class="card-banner img-holder" style="--width: 640; --height: 402;">
                  <img src="./RES/images/partner-2.jpg" width="640" height="402" loading="lazy" alt="Join Merchant"
                    class="img-cover">
                </figure>
      ...
      <section class="section newsletter" aria-label="newsletter">
        <div class="container">
          ...
          <figure class="newsletter-banner" data-reveal="left">
            <img src="./RES/images/newsletter-banenr.png" width="680" height="405" loading="lazy" alt="Illustration"
              class="w-100">
          </figure>
    ...
    <div class="container">
      ...
      <div class="section footer-top grid-list">
        ...
        <div class="footer-brand">
          ...
          <a href="#" class="logo">
            <img src="./RES/images/logo-footer.svg" width="148" height="38" alt="fasteat home">
          </a>

          <h2 class="h2 section-title">The Best Restaurants in Your Home</h2>

          <p class="section-text">
            Termd and Conditions applied.
          </p>
      ...
      <div class="footer-bottom">
        ...
        <p class="copyright">
          Done by Siddharthi for intern at Tech Alpha
        </p>
